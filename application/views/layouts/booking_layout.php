...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes, minimum-scale=0.5, maximum-scale=3">
    <meta name="theme-color" content="#35A768">
    <meta name="google" content="notranslate">

    <meta property="og:title" content="<?= lang('page_title') . ' ' . e(vars('company_name')) ?> | Bookings by Revclar"/>
    ...
    <title><?= lang('page_title') . ' ' . e(vars('company_name')) ?> | Bookings by Revclar</title>
