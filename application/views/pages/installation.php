...
<head>
    ...
    <title>Installation | Bookings by Revclar</title>
        ...
        <div class="row">
            <div class="col-lg-9 offset-lg-1">
                <h1 class="text-dark-emphasis fw-light py-5">
                    Bookings by Revclar Installation
                </h1>
            </div>
        </div>    
    </div>
...
<div class="container flex-grow-1">
    <div class="row">
        <div class="col-lg-9 offset-lg-1">
            ...
            <div>
                <h3>Welcome to the Bookings by Revclar installation page.</h3>

                <p class="text-break">
                    This page will help you set the main settings of your Bookings by Revclar installation. You will be able to
                    edit these settings and many more in the backend session of your system. Remember to use the
                    <strong class="text-primary">
                        <?= site_url('user/login') ?>
                    </strong> 
                    URL to connect to the backend section of Bookings by Revclar.

                    If you face any problems during the usage of Bookings by Revclar you can always check the
            ...
            <div class="mb-3">
                <h3>License</h3>
                Bookings by Revclar is licensed under the <span class="badge text-bg-primary">GPL-3.0 license</span>. By using the
                code of Bookings by Revclar in any way <br> you agree with the terms described in the following url:
