...
$lang['type'] = 'Type';
$lang['customer_package'] = 'Customer Package';
...
$lang['group_by_month'] = 'By month';
$lang['group_by_category'] = 'By category';
$lang['group_by_service'] = 'By service';
$lang['daily'] = 'Daily';
...
$lang['last_365_days'] = 'Last 365 days';
...
$lang['package_calculated_sum'] = 'Calculated Sum (Reference)';
$lang['validity_days'] = 'Validity (Days)';
$lang['package_items'] = 'Included Services';
$lang['add_item'] = 'Add Service';
$lang['package_price_hint'] = 'The manual package price. The calculated sum is for reference only.';
$lang['validity_days_hint'] = 'Number of days the package can be used after purchase.';
$lang['package_requires_items'] = 'The package must contain at least one service.';
$lang['package_invalid_items'] = 'All rows must have a selected service and a valid quantity.';
...
$lang['sell'] = 'Sell';
$lang['customer_package_saved'] = 'Customer package saved successfully.';
$lang['customer_package_deleted'] = 'Customer package deleted successfully.';
$lang['delete_customer_package'] = 'Delete Customer Package';
$lang['purchase_date'] = 'Purchase Date';
$lang['expiry_date'] = 'Expiry Date';
$lang['select_customer'] = 'Please select a customer.';
$lang['select_package'] = 'Please select a package.';
$lang['search_customer_placeholder'] = 'Search customer by name or email...';
$lang['remaining'] = 'Remaining';
$lang['total'] = 'Total';
$lang['reason'] = 'Reason';
$lang['invalid_remaining_quantity'] = 'The remaining quantity must be 0 or higher.';
$lang['customer_package_no_remaining_uses'] = 'The selected customer package has no remaining uses for this service.';
$lang['customer_package_not_active'] = 'The selected customer package is not active.';
$lang['customer_package_wrong_customer'] = 'The selected customer package does not belong to this customer.';
...
$lang['about_app'] = 'About Bookings by Revclar';
...
$lang['about_app_info'] = 'Bookings by Revclar is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Bookings by Revclar you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Bookings by Revclar is licensed under the GPLv3 license. By using the code of Bookings by Revclar in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'Bookings by Revclar has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the Bookings by Revclar API.';
...
$lang['whatsapp_qr_info'] = 'Connect your WhatsApp Business account via Evolution API to send automated messages to customers.';
$lang['marketing'] = 'Marketing';
$lang['meta_leads'] = 'Meta Leads';
$lang['meta_leads_hint'] = 'Leads received from Meta Lead Ads. Track who has been called and import a lead when creating an appointment.';
$lang['meta_leads_all'] = 'All';
$lang['meta_leads_status_new'] = 'New';
$lang['meta_leads_status_converted'] = 'Converted';
$lang['meta_leads_name'] = 'Name';
$lang['meta_leads_received_at'] = 'Received';
$lang['meta_leads_actions'] = 'Actions';
$lang['meta_leads_delete'] = 'Delete';
$lang['meta_leads_delete_confirm'] = 'Are you sure you want to delete this lead?';
$lang['meta_leads_view_title'] = 'Lead details';
$lang['meta_leads_no_form_fields'] = 'No additional answers';
...
$lang['call_status_de_sunat'] = 'To call';
$lang['call_status_nu_a_raspuns'] = 'No answer';
$lang['call_status_revine'] = 'Will call back';
$lang['call_status_nu_e_interesat'] = 'Not interested';
$lang['call_note'] = 'Note';
$lang['add_note'] = 'Add note';
$lang['edit_note'] = 'Edit note';
$lang['meta_leads_note_history'] = 'Note history';
$lang['meta_leads_note_new'] = 'New note';
$lang['meta_leads_no_notes'] = 'No notes.';
$lang['assigned_to'] = 'Assigned to';
$lang['unassigned'] = 'Unassigned';
$lang['has_appointment'] = 'Has appointment';
$lang['no_phone'] = 'No phone';
$lang['meta_leads_form_answers'] = 'Form answers';
...
$lang['meta_leads_ai_no_answer'] = 'NO ANSWER';
$lang['meta_leads_ai_failed'] = 'CALL FAILED';
$lang['meta_leads_ai_summary_label'] = 'Call summary';
$lang['meta_leads_ai_desired_procedure_label'] = 'Desired procedure';
$lang['meta_leads_ai_attempt_label'] = 'Attempt';
$lang['meta_leads_ai_no_summary'] = 'No summary.';
$lang['relative_time_just_now'] = 'just now';
$lang['relative_time_minutes'] = '%d min ago';
$lang['relative_time_hours'] = '%d hours ago';
$lang['relative_time_days'] = '%d days ago';
$lang['relative_time_weeks'] = '%d weeks ago';
$lang['relative_time_months'] = '%d months ago';
$lang['relative_time_years'] = '%d years ago';
...
$lang['campaign_procedure_placeholder'] = 'e.g. Body contouring';
$lang['campaign_discount'] = 'Discount';
$lang['campaign_valid_until'] = 'Valid until';
$lang['marketing_recipients_hint'] = 'Will be sent to customers with a valid number:';
$lang['send_to_all'] = 'Send to all';
$lang['message_preview'] = 'Message preview';
$lang['marketing_preview_greeting'] = 'Hi,';
$lang['marketing_preview_name'] = 'Customer Name';
$lang['marketing_preview_offer'] = 'SPECIAL offer just for you!';
$lang['marketing_preview_procedure'] = 'Procedure';
$lang['marketing_preview_discount'] = 'with DISCOUNT';
$lang['marketing_preview_valid_until'] = 'Valid until';
$lang['marketing_preview_cta'] = 'Book NOW!';
$lang['sending_progress'] = 'Sending progress';
$lang['marketing_sent'] = 'Sent';
$lang['marketing_failed'] = 'Failed';
$lang['marketing_fill_all_fields'] = 'Please fill in all campaign fields before sending.';
$lang['marketing_confirm_send'] = 'Are you sure you want to send the marketing message to all customers?';
$lang['marketing_send_error'] = 'An error occurred while sending. Check the results and try again.';
$lang['marketing_campaign_finished'] = 'Campaign finished';
$lang['marketing_test_phone'] = 'Test number';
$lang['marketing_test_phone_placeholder'] = 'e.g. 0722334455';
$lang['marketing_send_test'] = 'Send test';
$lang['marketing_test_sent'] = 'Test message sent. Check WhatsApp!';
$lang['marketing_test_invalid_phone'] = 'The entered phone number is not valid.';
$lang['marketing_test_phone_required'] = 'Please enter a phone number for the test.';
$lang['scan_qr_hint'] = 'Scan the QR code with WhatsApp on your phone: Settings → Linked Devices → Link a Device.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the Bookings by Revclar data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['status'] = 'Status';
$lang['close_appointment'] = 'Finalize Appointment';
$lang['price'] = 'Price';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into Bookings by Revclar and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
...
$lang['persoana_fizica'] = 'Individual';
$lang['persoana_juridica'] = 'Company';
$lang['search_client'] = 'Search client (name or fiscal code)';
$lang['new_client'] = 'New client';
$lang['change_client'] = 'Change client';
$lang['cui'] = 'Fiscal code (CUI)';
$lang['reg_com'] = 'Trade register no.';
$lang['county'] = 'County';
$lang['lookup_anaf'] = 'Look up in ANAF';
$lang['invalid_cui'] = 'Invalid fiscal code.';
$lang['anaf_not_found'] = 'Fiscal code not found in ANAF. Fill in manually.';
$lang['anaf_unavailable'] = 'The ANAF service is not responding. Fill in manually.';
$lang['anaf_data_loaded'] = 'Data loaded from ANAF.';
$lang['vat_payer'] = 'VAT payer';
$lang['client_saved'] = 'Client saved and selected.';
$lang['client_save_error'] = 'The client could not be saved. Check the required fields (name, fiscal code for companies).';
$lang['products'] = 'Products';
$lang['coming_soon'] = 'Coming soon';
$lang['manual_line'] = 'Manual line';
$lang['qty'] = 'Qty';
...
$lang['vat'] = 'VAT';
$lang['client'] = 'Client';
$lang['invoice_number'] = 'Number';
$lang['issue_date'] = 'Issue date';
$lang['payment_method'] = 'Payment method';
$lang['bank_transfer'] = 'Bank transfer';
$lang['is_draft_mode'] = 'Test mode (draft)';
$lang['is_draft_hint'] = 'In test mode the invoice is created as a draft in SmartBill (not a fiscal document). Uncheck for real issuance.';
$lang['select_client_first'] = 'Select or create a client first.';
$lang['add_line_first'] = 'Add at least one invoice line.';
$lang['select_issue_date'] = 'Pick the issue date.';
$lang['invoice_issued'] = 'Invoice issued:';
$lang['invoice_issue_failed'] = 'Invoice issuance failed.';
$lang['smartbill_not_configured'] = 'SmartBill is not configured (SMARTBILL_* env vars missing on the server).';
$lang['no_invoices'] = 'No invoices issued yet.';
