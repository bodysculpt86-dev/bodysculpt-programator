...
$config['sess_match_ip'] = false; // Disabled: IP can vary behind a proxy (Railway)
...
$config['csrf_exclude_uris'] = ['api/v1/.*', 'booking/.*', 'booking_cancellation/.*', 'booking_confirmation/.*', 'webhooks/stripe', 'webhooks/meta', 'webhooks/make', 'webhooks/autocalls'];
